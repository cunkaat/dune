var strokecolor = {
  ...
  function circles() {
      ...
      ellipse(170+100, height-200, 50, 50); //left
      ellipse(230+100, height-200, 50, 50); //right
      ellipse(width/2, 170, 50, 50); // top
      ellipse(width/2, 230, 50, 50); // bottom
      ellipse(180+100, height-220, 50, 50); // upper left
      ellipse(220+100, height-220, 50, 50); //upper right
      ellipse(180+100, height-180, 50, 50); // bottom left 
      ellipse(220+100, height-180, 50, 50); // bottom right
